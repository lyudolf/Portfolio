...
const APPS = [
     ...
     시간순으로는 가장 앞이라 목록 맨 앞에 둔다. */
  {
    ...
    decisions: [
      ...
      {
        t: '처음으로 측정을 붙였다 — 고 생각했다',
        d: 'Firebase Analytics를 연동해 사용자가 어디서 멈추는지 보려 했습니다. 앞선 작업들이 "만들고 끝"이었던 걸 고치려는 첫 시도였는데, 나중에 확인해보니 데이터가 아예 수집되고 있지 않았습니다. 붙였다고 믿고 한 번도 열어보지 않은 게 원인이었습니다.',
      },
    ],
  },
  {
...
const LEARNED = [
  ...
  {
    t: '측정을 붙이는 것과 측정되는 것은 다릅니다',
    d: 'PillStack에 Firebase Analytics를 연동하며 이제 데이터를 본다고 생각했습니다. 한참 뒤에 열어보니 아무것도 쌓여 있지 않았습니다. 연동은 시작이지 완료가 아니라는 것, 대시보드를 한 번이라도 열어봤다면 바로 알았을 일이라는 것을 그때 배웠습니다.',
  },
  {
