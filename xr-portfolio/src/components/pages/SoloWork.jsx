...
const APPS = [
  /* PillStack — 앱인토스 네 종보다 먼저 만든 실용 도구.
     콘텐츠 앱이 아니라 공공 의료 데이터를 다뤘고, 유일하게 측정을 붙인 시도.
     시간순으로는 가장 앞이라 목록 맨 앞에 둔다. */
  {
    id: 'pillstack',
    name: 'PillStack',
    appName: 'medicheck',
    ...
    released: '출시 후 운영 중단',
    color: '#7a6ce0',
    summary: '영양제 성분을 분석하고 함께 먹어도 되는지 확인하는 도구. 공공 의약품 데이터를 붙였습니다.',
    decisions: [
      {
        t: '전문 용어를 소비자의 질문으로 번역',
        d: '공공 API가 주는 건 의약품 상호작용 코드와 성분명입니다. 일반 사용자가 궁금한 건 "이거 같이 먹어도 되나" 하나였습니다. 데이터 구조가 아니라 그 질문을 화면의 중심에 뒀습니다.',
      },
      {
        t: 'AI가 "붙였다"고 한 것을 확인하지 않았습니다',
        d: '출시 후 사용자가 어디서 멈추는지 보려고 Firebase Analytics 연동을 AI에게 맡겼고, 완료됐다는 답을 그대로 믿었습니다. 한참 뒤에 열어보니 데이터가 하나도 쌓여 있지 않았습니다. 코드가 있는 것과 실제로 동작하는 것은 다른데, 그 사이를 확인하는 일만은 위임할 수 없다는 걸 여기서 놓쪤습니다.',
      },
    ],
  },
  {
...
const LEARNED = [
  ...
  {
    t: '위임은 되지만 검증은 위임되지 않습니다',
    d: 'AI를 써서 빠르게 만드는 건 이제 익숙합니다. 그런데 PillStack에서는 "연동 완료"라는 답을 확인 없이 받았고, 정작 데이터는 수집되지 않고 있었습니다. 만드는 속도를 올린 만큼 확인하는 순서를 짠 사람이 반드시 가져야 한다는 걸 이때 배웠습니다. 지금은 AI에 맡긴 작업일수록 "됐다"가 아니라 "되는 걸 봤다"까지 확인합니다.',
  },
  {
    t: '다음에는 채널부터 정하고 시작합니다',
    d: '무엇을 만들지보다 "누가 어디서 이걸 처음 보게 되는가"를 먼저 정하려 합니다. 재방문 장치는 다 넣었지만 그게 작동하는지 판단할 표본이 없었습니다. 리텐션은 유입 다음의 문제라는 걸 다섯 번 확인했습니다.',
  },
];
