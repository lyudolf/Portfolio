...
export const QA = [
  {
    q: '프로젝트 개요',
    a: [
      '웹에이전시 웹마인드에서 1년 4개월간(2023.04 — 2024.07) B2B 웹/앱 구축을 기획했습니다. 제안 PT로 수주를 만들고, 구축이 끝나면 유지보수로 관계를 이어가는 — 기획이 곧 영업이고 운영인 환경이었습니다.',
    ],
  },
  {
    q: '문제 정의',
    a: [
      '"사이트를 더 좋게"라는 문장에서 시작해, 예산과 일정이 고정된 채로 무엇을 만들지부터 정의해야 했습니다.',
    ],
  },
  {
    q: '방향 설정',
