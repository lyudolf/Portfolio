    ...
    <div style={{ background: '#080A0F' }}>
      ...
      <section className="relative min-h-[100vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 opacity-[0.025]"
          style={{ backgroundImage: 'linear-gradient(rgba(255,255,255,0.12) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.12) 1px, transparent 1px)', backgroundSize: '80px 80px' }} />
      ...
      <section className="max-w-5xl mx-auto px-8 pb-32">
        <FadeIn>
          <p className="text-label mb-10" style={{ color: '#546178' }}>Projects & Capabilities</p>
        </FadeIn>

        <FadeIn delay={0.05}>
          {/* 
            Reference layout (3 cols × 3 rows):
            Row 1: [small] [small] [tall 2-row]
            Row 2: [wide 2-col 2-row]  [tall cont.]
            Row 3: [wide cont.]  [small] [small]
          */}
          <MagicBento gridClassName="grid grid-cols-4 gap-3" gridStyle={{ gridAutoRows: '160px' }}>

            {/* Row 1 — Top-left: 2 small cards */}
            <MagicBento.Card className="col-span-2 row-span-1 p-6 flex flex-col justify-between"
            ...
            <MagicBento.Card className="p-7 flex flex-col justify-between"
            ...
            <MagicBento.Card className="p-6 flex flex-col justify-between"
