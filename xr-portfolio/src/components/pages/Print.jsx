...
/* ── 표지·직업관 확정본 ──
   2026-09-16 본인 문장으로 확정: "몰입할 환경은 스스로 만들고, 결과로 증명합니다."
   (본인 초안 "몰입할 수 있는 환경을 구축하고 결과로 증명합니다"에서 XR 오독을 막는 "스스로"만 추가).
   사실 줄은 서브로, 태그는 그대로. 랜딩 히어로와 같은 문장. */
const COVER_MAIN_1 = '몰입할 환경은 스스로 만들고,';
const COVER_MAIN_2 = '결과로 증명합니다.';
const COVER_SUB = '임상 XR 시스템 3년 운영 · 캠페인 플랫폼 1인 구축 · 앱 5종 출시 · 웹어워드 코리아 금상';
