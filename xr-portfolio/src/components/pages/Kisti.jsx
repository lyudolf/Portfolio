...
const PROBLEMS = [
  { title: '과도한 시각적 정보량', desc: '무한하게 펼쳐진 공간형 씬은 시각적 정보량이 과했고, 목표 오브젝트에 집중하기 어려웠습니다.' },
  { title: '높은 멀미·적응 부담', desc: 'VR 환경에 익숙하지 않은 고령자에게는 공간 적응과 멀미 부담이 컸습니다.' },
  { title: '깊은 Depth의 운영 구조', desc: '교수자/훈련자 depth가 지나치게 깊고, 정보 구조가 정리되어 있지 않았습니다.' },
  { title: '불안정한 레거시 구조', desc: '기존 업체의 코드와 구조를 인수받은 상태에서 일정은 이미 불안정했습니다.' },
];
