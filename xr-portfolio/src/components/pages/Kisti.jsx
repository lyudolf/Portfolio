...
export const SCREENS = [
  ...
  },
  {
    ...
    note: '고령자 대상이라 낙상·이탈은 즉시 알아야 했습니다.',
  },
];
...
export const QA = [
  {
    q: '프로젝트 개요',
    a: [
      'KISTI(한국과학기술정보연구원)가 주관하는 대형 국가과제의 세부 과제 — 고령자의 인지와 운동 기능을 함께 훈련하고, 그 과정을 임상 연구 데이터로 수집하는 XR 시스템입니다. 연구로 끝나지 않고 기업 기술이전까지 가는 것이 최종 목적이라, 팔 수 있는 제품을 기준으로 판단해야 했습니다.',
      '병원에서 씁니다. 사용자는 두 종류입니다 — 훈련을 직접 받는 50세 이상 훈련자, 그리고 진행을 주관하고 관찰하는 교수자. 저는 6년 사업의 3년차에 투입돼 기획과 PM을 맡았습니다.',
    ],
  },
  {
    q: '문제 정의',
    a: [
      ...
      '가장 막막했던 건 "어디까지가 확정된 결정이고, 어디부터 손대도 되는가"였습니다. 실마리는 1·2·3년차 구축 업체가 매년 바뀌었다는 사실이었습니다 — 클라이언트가 원하는 걸 아직 받지 못했다는 뜻이라고 봤습니다. 확정 여부를 확인받는 대신, 인계 첫 2주간 제안서와 자료를 전부 분석해 새로 쓴 기획서와 런처 UI·UX 설계, 레벨 디자인 설계를 들고 먼저 미팅을 잡았습니다.',
    ],
    blocks: [
      {
        type: 'issues',
...
/* 본문 하단 보충 설명. 본인 구술 답변(2026-08-26)을 정리한 것.
   ...
   본문 01·02·03으로 올렸고, 여기엔 가벼운 사실 확인 3개만 남긴다.
