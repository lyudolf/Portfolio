...
export const QA = [
  ...
  },
  {
    ...
    a: [
      ...
      '가장 막막했던 건 "어디까지가 확정된 결정이고, 어디부터 손대도 되는가"였습니다. 실마리는 1·2·3년차 구축 업체가 매년 바뀌었다는 사실이었습니다 — 클라이언트가 원하는 걸 아직 받지 못했다는 뜻이라고 봤습니다. 확정 여부를 확인받는 대신, 인계 첫 2주간 제안서와 자료를 전부 분석해 새로 쓴 기획서와 런처 UI·UX 설계, 레벨 디자인 설계를 들고 먼저 미팅을 잡았습니다. 지금 돌아보면 그 미팅이 클라이언트와 신뢰를 쌓은 기점이었습니다.',
    ],
    blocks: [
      {
        type: 'issues',
